...
describe('Les chaines de caractères : ', function () {
    ...
    it('Supprimer les espaces avant et après la chaine', function () {
        ...
        expect(result).toEqual('Rome ne s\'est pas construite en un jour'); // OK
    });
